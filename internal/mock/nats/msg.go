...
func (mr *MockNatsMsgMockRecorder) DoubleAck(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockNatsMsg) NakWithDelay(arg0 time.Duration) error {
	m.ctrl.T.Helper()
...
func (mr *MockNatsMsgMockRecorder) NakWithDelay(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NakWithDelay", reflect.TypeOf((*MockNatsMsg)(nil).NakWithDelay), arg0)
}
...
func (m *MockNatsMsg) TermWithReason(arg0 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockNatsMsgMockRecorder) TermWithReason(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TermWithReason", reflect.TypeOf((*MockNatsMsg)(nil).TermWithReason), arg0)
}
